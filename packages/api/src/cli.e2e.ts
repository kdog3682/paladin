...
import { glob, collectFiles, getMostRecentFile } from "./utils/fs"

await incrementArtifact(await getMostRecentFile(process.env.SCRATCH_DIR, 'json'))
// writes the file
...
// // spawn api
// const api = Bun.spawn({
//   cmd: ["bun", "--watch", "src/cli.ts", '--watch', 'false'],
//   env: {
//     ...process.env,
//     SCRATCH_DIR: scratch,
...
//     PORT: "3999",
//   },
//   cwd: '/home/kdog3682/projects/paladin/packages/api',
//   stdout: "pipe",
//   stderr: "pipe",
// })
...
//   userText: "@paladin/api write resolve-path.ts and its demo",
//   artifacts: [
//     makeArtifact({
...
//   ['bun', '/home/kdog3682/projects/paladin/packages/api/src/cli.ts', '--dry', '--force']
// )
// console.log(res.stdout)
// // assertions
// const files = await collectFiles(projects, {include: 'resolve-path'})
...
// if (!hasMain || !hasDemo) await cleanup(1, "error: missing expected files")
