...
/** Resolves ~/projects/<projectName>/src/packages/<pkgName>. */
export function resolveProjectPackageDir(projectName: string, pkgName: string): string {
  return join(expandHome('~/projects'), projectName, 'src', 'packages', pkgName)
}