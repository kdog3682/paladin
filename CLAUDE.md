The project is a bun typescript monorepo.

Coding Style:
  - no semicolons
  - Keep things in one function unless composable or reusable
  - Avoid try/catch where possible
  - Prefer single word variable names and file names when possible
  - Code should be written simple and straightforward.
